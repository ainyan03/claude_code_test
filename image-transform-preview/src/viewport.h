...
// ========================================================================
//
// ViewPortは、Image/Image16を統合した新しい画像型です。
...
struct ViewPort {
    ...
    // ========================================================================
    // Image/Image16 からの変換（移行用ヘルパー）
    // ========================================================================

    // Image（8bit RGBA）からViewPortを作成
    static ViewPort fromImage(const Image& img);

    // Image16（16bit RGBA）からViewPortを作成
    static ViewPort fromImage16(const Image16& img);

    // ========================================================================
    // Image/Image16 への変換（移行用ヘルパー）
    // ========================================================================
    ...
    // ViewPortからImage16（16bit RGBA）を作成
    // 注意: formatIDがRGBA16系でない場合は変換が必要
    Image16 toImage16() const;
